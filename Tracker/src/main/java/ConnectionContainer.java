...
public class ConnectionContainer {
    ...
    public void onClientConnected(int clientId, Connection connection) {
        ...
        logger.info(String.format("New Connection has been established with id: %d", clientId));
    }
    ...
    public void onClientDisconnected(int clientId) {
        ...
        logger.info(String.format("Connection with id: %d has been closed", clientId));
    }
